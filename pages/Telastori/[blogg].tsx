                    ...
                    <div className="OvarlayColor">
                      <div className="cardContent">
                        ...
                        <div className="overview">
                          ...
                          cooking experiences for the world&#39;s leading
                          appliance brands and home cooks. They originally came
                          to Mawla in 2022 because they needed a new marketing
                          site as part of their rebrand to reflect the
                          company&#39;s growth.s
                        </div>
                      </div>
                    </div>
                  ...
                  <RelatedCard imageUrl="https://miro.medium.com/v2/resize:fit:720/0*dXTEWRECBHcbLgTZ">
                    <div className="OvarlayColor">
                      <div className="cardContent">
                        ...
                        <div className="overview">
                          Passive income is income that is generated with
                          minimal effort or time. This type of income is
                          typically generated through investments or other forms
                          of passive income-generating activities such as
                          renting out the property, creating digital products
                          (e.g. online courses), and so on. Passive income is
                          important to have multiple streams…
                        </div>
                      </div>
                    </div>
                  </RelatedCard>
                  <RelatedCard imageUrl="https://miro.medium.com/v2/resize:fit:720/0*xLIQQ3iLqGqz8LFz">
                    <div className="OvarlayColor">
                      <div className="cardContent">
                        ...
                        <div className="overview">
                          Procrastination is a big problem for many of us. We
                          say we&#39;ll work on our goals, hit the gym, or learn
                          some new skills, only to end up watching Netflix
                          instead. I used to be a chronic procrastinator too.
                          I&#39;d set big goals and make ambitious plans, but
                          not much was getting done on a day-to-day basis.
                        </div>
                      </div>
                    </div>
                  </RelatedCard>
                ...
                <div className="OvarlayColor">
                  <div className="cardContent">
                    ...
                    <div className="overview">
                      ...
                      we&#39;ll work on our goals, hit the gym, or learn some
                      new skills, only to end up watching Netflix instead. I
                      used to be a chronic procrastinator too. I&#39;d set big
                      goals and make ambitious plans, but not much was getting
